...
export const BESTIARIO: Record<string, MonsterTemplate> = {
  ...
  arqueiro_glorienn: {
    ...
    poder: 3, habilidade: 4, resistencia: 3,
    hp: 12,
  ...
  sharindhallenrannas: {
    ...
    poder: 2, habilidade: 4, resistencia: 2,
    hp: 9,
  ...
  sprite_mago: {
    ...
    poder: 0, habilidade: 5, resistencia: 2,
  ...
  lagarto_gigante: {
    ...
    poder: 1, habilidade: 2, resistencia: 3,
    xpReward: 9, goldReward: 0,
  },
  fada_lena: {
    ...
    poder: 0, habilidade: 4, resistencia: 2,
    xpReward: 6, goldReward: 0,
  },
  unicornio_enorme: {
  ...
  tandan: {
    ...
    poder: 4, habilidade: 4, resistencia: 3,
    hp: 18,
  ...
  golem_pedra: {
    ...
    poder: 2, habilidade: 1, resistencia: 4,
    xpReward: 16, goldReward: 0,
  },
  gargula: {
  ...
  phasm: {
    ...
    poder: 0, habilidade: 3, resistencia: 3,
    xpReward: 9, goldReward: 0,
  },
  tigre_hyninn: {
    ...
    poder: 1, habilidade: 4, resistencia: 1,
    xpReward: 11, goldReward: 0,
  },
  armario_animado: {
    ...
    poder: 1, habilidade: 1, resistencia: 4,
    hp: 25,
    xpReward: 14, goldReward: 0,
  },
  bau_animado: {
    ...
    poder: 1, habilidade: 1, resistencia: 3,
    hp: 20,
    xpReward: 11, goldReward: 0,
  },
  corrente_animada: {
  ...
  clerigo_marah: {
    ...
    poder: 0, habilidade: 4, resistencia: 3,
  ...
  sprite_feiticeiro_marah: {
    ...
    poder: 0, habilidade: 4, resistencia: 1,
    hp: 9,
    xpReward: 7, goldReward: 0,
  },
  estatua_viva: {
  ...
  driade_marah: {
    ...
    poder: 0, habilidade: 3, resistencia: 2,
    hp: 10,
    xpReward: 8, goldReward: 0,
  },
  prislanya: {
    ...
    poder: 0, habilidade: 1, resistencia: 2,
    hp: 10,
  ...
  verrkash: {
    ...
    poder: 0, habilidade: 5, resistencia: 4,
    hp: 25,
    xpReward: 24, goldReward: 0,
  },
  ravarimm: {
  ...
  ginoesfinge: {
    ...
    poder: 1, habilidade: 4, resistencia: 4,
  ...
  escorpiao_colossal: {
    ...
    poder: 3, habilidade: 1, resistencia: 4,
    xpReward: 22, goldReward: 0,
  },
  elemental_areia: {
    ...
    poder: 4, habilidade: 6, resistencia: 3,
    xpReward: 24, goldReward: 0,
  },
  efreet: {
  ...
  golem_pedra_tauron: {
    ...
    poder: 2, habilidade: 2, resistencia: 5,
    xpReward: 20, goldReward: 0,
  },
  verme_purpura: {
  ...
  liranny: {
    ...
    poder: 2, habilidade: 2, resistencia: 1,
    hp: 4,
    xpReward: 6, goldReward: 0,
  },
  thwor_ironfist: {
    ...
    poder: 3, habilidade: 6, resistencia: 5,
    hp: 16,
    xpReward: 20, goldReward: 0,
  },
  sathane: {
  ...
  yon_ude: {
    ...
    poder: 3, habilidade: 5, resistencia: 3,
    hp: 20,
  ...
  darkazimm: {
    ...
    poder: 3, habilidade: 6, resistencia: 4,
    hp: 30,
  ...
  tojanida_imensa: {
    ...
    poder: 3, habilidade: 7, resistencia: 6,
    xpReward: 26, goldReward: 0,
  },
  homem_selako: {
  ...
  coriphena: {
    ...
    poder: 8, habilidade: 8, resistencia: 8,
    hp: 40,
  ...
  dragao_vermelho_adulto: {
    ...
    poder: 7, habilidade: 6, resistencia: 7,
    hp: 35,
    xpReward: 48, goldReward: 20,
  },
  dragao_vermelho_experiente: {
    ...
    poder: 8, habilidade: 7, resistencia: 8,
    hp: 40,
    xpReward: 55, goldReward: 25,
  },
  reyjane: {
    ...
    poder: 6, habilidade: 6, resistencia: 6,
    hp: 35,
  ...
  behir_imenso: {
    ...
    poder: 6, habilidade: 3, resistencia: 4,
  ...
  tarrasque: {
    ...
    poder: 4, habilidade: 5, resistencia: 9,
  ...
  karlya: {
    ...
    poder: 1, habilidade: 5, resistencia: 4,
    hp: 21,
    xpReward: 30, goldReward: 0,
  },
  ...
  bhaltan: {
    ...
    poder: 5, habilidade: 5, resistencia: 7,
    hp: 45,
    xpReward: 55, goldReward: 25,
  },
  avatar_valkaria: {
    ...
    poder: 17, habilidade: 10, resistencia: 20,
    hp: 100,
