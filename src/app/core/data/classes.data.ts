...
// Atributos base 3D&T Victory: Poder, Habilidade, Resistência (Armadura é equipamento)
export const ALL_CLASSES: ClassDef[] = [
  {
    ...
    baseStats: { poder: 3, habilidade: 2, resistencia: 3 },
    pvBase: 20,
    freeVantagens: [
  ...
  },
  {
    ...
    baseStats: { poder: 9, habilidade: 3, resistencia: 2 },
    pvBase: 10,
    freeVantagens: [
  ...
  },
  {
    ...
    baseStats: { poder: 2, habilidade: 4, resistencia: 2 },
    pvBase: 12,
    freeVantagens: [
  ...
  },
  {
    ...
    baseStats: { poder: 8, habilidade: 2, resistencia: 3 },
    pvBase: 16,
    freeVantagens: [
  ...
  },
  {
    ...
    baseStats: { poder: 4, habilidade: 3, resistencia: 2 },
    pvBase: 14,
    freeVantagens: [
  ...
  },
  {
    ...
    baseStats: { poder: 5, habilidade: 3, resistencia: 2 },
    pvBase: 12,
    freeVantagens: [
  ...
  },
  {
    ...
    baseStats: { poder: 5, habilidade: 2, resistencia: 3 },
    pvBase: 18,
    freeVantagens: [
  ...
  },
  {
    ...
    baseStats: { poder: 3, habilidade: 2, resistencia: 4 },
    pvBase: 22,
    freeVantagens: [
      { name: 'Fúria Bárbara', description: 'Gasta 2 PM (ou 0 se não tiver PM): +2 P e +2 R por 3 rodadas. Após, fica Fatigado (−1 P e R) por 1 rodada.' },
      { name: 'Alma Primitiva', description: '+2 em testes de Resistência contra magias e efeitos mentais. Imune a Medo.' }
    ],
    traits: [
      'P3 H2 R4',
      'Fúria Bárbara: +2P+2R por 3 rodadas',
      'Imune a Medo',
  ...
  },
  {
    ...
    baseStats: { poder: 6, habilidade: 4, resistencia: 2 },
    pvBase: 14,
    freeVantagens: [
      { name: 'Ataque Desarmado', description: 'Ataques sem arma causam 1d6+P de dano (como uma arma média). Pode realizar dois ataques desarmados por rodada.' },
      { name: 'Armadura de Ki', description: 'Usa H como bônus de Armadura quando desarmado e sem armadura. PM funciona como reserva de Ki para habilidades.' }
    ],
    traits: [
      'P6 H4 R2',
      'Ataque desarmado: 1d6+P (dois por rodada)',
