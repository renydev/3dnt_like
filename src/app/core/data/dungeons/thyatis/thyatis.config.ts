...
//  fileira 1 (trivial): elemental_fogo_anciao
//  fileira 2 (trivial): elemental_fogo_anciao
//  fileira 3 (equilibrado): elemental_fogo_anciao
//  fileira 4 (arriscado): mastim_thyatis
//  fileira 5 (mortal): thoqqa
//  chefe: reyjane
export const ThyatisConfig: DungeonConfig = {
  ...
  layout: {
    ...
    rooms: [
      ...
      { id: 1, row: 1, col: -1, type: 'monster', name: 'Trilha de Elemental do Fogo Ancião', connections: [0, 3] },
      { id: 2, row: 1, col: 1, type: 'trap', name: 'Corredor Armado', connections: [0, 4] },
      { id: 3, row: 2, col: -2, type: 'monster', name: 'Covil de Elemental do Fogo Ancião', connections: [1, 6] },
      ...
      { id: 6, row: 3, col: -3, type: 'monster', name: 'Território de Elemental do Fogo Ancião', connections: [3, 7] },
      ...
      { id: 10, row: 4, col: -2, type: 'monster', name: 'Covil de Mastim de Thyatis', connections: [7, 13] },
      ...
      { id: 13, row: 5, col: -1, type: 'monster', name: 'Ninho de Thoqqa', connections: [10, 15] },
