...
//  fileira 1 (trivial): goblin_guerreiro
//  fileira 2 (trivial): goblin_guerreiro
//  fileira 3 (equilibrado): orc_berserker
//  fileira 4 (arriscado): orc_guerreiro
//  fileira 5 (mortal): troll_guerra
//  chefe: gromthar + ogre_batalha + hobgoblin_capitao
export const RagnarConfig: DungeonConfig = {
  ...
  layout: {
    ...
    rooms: [
      ...
      { id: 1, row: 1, col: -1, type: 'monster', name: 'Trilha de Goblin Guerreiro', connections: [0, 3] },
      { id: 2, row: 1, col: 1, type: 'trap', name: 'Corredor Armado', connections: [0, 4] },
      { id: 3, row: 2, col: -2, type: 'monster', name: 'Covil de Goblin Guerreiro', connections: [1, 6] },
      ...
      { id: 6, row: 3, col: -3, type: 'monster', name: 'Território de Orc Berserker', connections: [3, 7] },
      ...
      { id: 10, row: 4, col: -2, type: 'monster', name: 'Covil de Orc Guerreiro', connections: [7, 13] },
      ...
      { id: 13, row: 5, col: -1, type: 'monster', name: 'Ninho de Troll da Guerra', connections: [10, 15] },
