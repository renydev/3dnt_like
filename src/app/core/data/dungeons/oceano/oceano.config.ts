...
//  fileira 1 (trivial): homem_selako
//  fileira 2 (trivial): sereia_feiticeira
//  fileira 3 (equilibrado): elfo_mar_ranger
//  fileira 4 (arriscado): elfo_mar_barbaro
//  fileira 5 (mortal): tojanida_imensa
//  chefe: coriphena
export const OceanoConfig: DungeonConfig = {
  ...
  layout: {
    ...
    rooms: [
      ...
      { id: 1, row: 1, col: -1, type: 'monster', name: 'Trilha de Homem-Selako', connections: [0, 3] },
      { id: 2, row: 1, col: 1, type: 'trap', name: 'Corredor Armado', connections: [0, 4] },
      { id: 3, row: 2, col: -2, type: 'monster', name: 'Covil de Sereia Feiticeira', connections: [1, 6] },
      ...
      { id: 6, row: 3, col: -3, type: 'monster', name: 'Território de Elfo-do-Mar Ranger', connections: [3, 7] },
      ...
      { id: 10, row: 4, col: -2, type: 'monster', name: 'Covil de Elfo-do-Mar Bárbaro', connections: [7, 13] },
      ...
      { id: 13, row: 5, col: -1, type: 'monster', name: 'Ninho de Tojanida Anciã Imensa', connections: [10, 15] },
