...
//  fileira 1 (trivial): enxame_azgher
//  fileira 2 (trivial): enxame_azgher
//  fileira 3 (equilibrado): enxame_azgher
//  fileira 4 (arriscado): lamia
//  fileira 5 (mortal): androesfinge
//  chefe: alkhab
export const AzgherConfig: DungeonConfig = {
  ...
  layout: {
    ...
    rooms: [
      ...
      { id: 1, row: 1, col: -1, type: 'monster', name: 'Trilha de Enxame de Azgher', connections: [0, 3] },
      { id: 2, row: 1, col: 1, type: 'trap', name: 'Corredor Armado', connections: [0, 4] },
      { id: 3, row: 2, col: -2, type: 'monster', name: 'Covil de Enxame de Azgher', connections: [1, 6] },
      ...
      { id: 6, row: 3, col: -3, type: 'monster', name: 'Território de Enxame de Azgher', connections: [3, 7] },
      ...
      { id: 10, row: 4, col: -2, type: 'monster', name: 'Covil de Lamia', connections: [7, 13] },
      ...
      { id: 13, row: 5, col: -1, type: 'monster', name: 'Ninho de Andro-Esfinge', connections: [10, 15] },
