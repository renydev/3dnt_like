...
//  fileira 1 (trivial): artista_marcial
//  fileira 2 (trivial): artista_marcial
//  fileira 3 (equilibrado + resgate de refém): artista_marcial
//  fileira 4 (arriscado): artista_marcial
//  fileira 5 (mortal): artista_marcial
//  chefe: yon_ude
export const LinWuConfig: DungeonConfig = {
  ...
  layout: {
    ...
    rooms: [
      ...
      { id: 1, row: 1, col: -1, type: 'monster', name: 'Trilha de Artista Marcial', connections: [0, 3] },
      { id: 2, row: 1, col: 1, type: 'trap', name: 'Corredor Armado', connections: [0, 4] },
      { id: 3, row: 2, col: -2, type: 'monster', name: 'Covil de Artista Marcial', connections: [1, 6] },
      ...
      { id: 6, row: 3, col: -3, type: 'monster', name: 'Território de Artista Marcial', connections: [3, 7] },
      ...
      { id: 10, row: 4, col: -2, type: 'monster', name: 'Covil de Artista Marcial', connections: [7, 13] },
      ...
      { id: 13, row: 5, col: -1, type: 'monster', name: 'Ninho de Artista Marcial', connections: [10, 15] },
