...
//  fileira 1 (trivial): cacador_glorienn
//  fileira 2 (trivial): arqueiro_elfo
//  fileira 3 (equilibrado): arqueiro_glorienn
//  fileira 4 (arriscado): arqueiro_glorienn
//  fileira 5 (mortal): arqueiro_glorienn
//  chefe: sharindhallenrannas
export const GloriennConfig: DungeonConfig = {
  ...
  layout: {
    ...
    rooms: [
      ...
      { id: 1, row: 1, col: -1, type: 'monster', name: 'Trilha de Caçador de Glorienn', connections: [0, 3] },
      { id: 2, row: 1, col: 1, type: 'trap', name: 'Corredor Armado', connections: [0, 4] },
      { id: 3, row: 2, col: -2, type: 'monster', name: 'Covil de Arqueiro Élfico', connections: [1, 6] },
      ...
      { id: 6, row: 3, col: -3, type: 'monster', name: 'Território de Arqueiro de Glorienn', connections: [3, 7] },
      ...
      { id: 10, row: 4, col: -2, type: 'monster', name: 'Covil de Arqueiro de Glorienn', connections: [7, 13] },
      ...
      { id: 13, row: 5, col: -1, type: 'monster', name: 'Ninho de Arqueiro de Glorienn', connections: [10, 15] },
