...
//  fileira 1 (trivial): bodak
//  fileira 2 (trivial): aparicao
//  fileira 3 (equilibrado): troglodita_guerreiro
//  fileira 4 (arriscado): vulto_alado
//  fileira 5 (mortal): esqueleto_colossal
//  chefe: ravarimm
export const TenebraConfig: DungeonConfig = {
  ...
  layout: {
    ...
    rooms: [
      ...
      { id: 1, row: 1, col: -1, type: 'monster', name: 'Trilha de Bodak', connections: [0, 3] },
      { id: 2, row: 1, col: 1, type: 'trap', name: 'Corredor Armado', connections: [0, 4] },
      { id: 3, row: 2, col: -2, type: 'monster', name: 'Covil de Aparição', connections: [1, 6] },
      ...
      { id: 6, row: 3, col: -3, type: 'monster', name: 'Território de Troglodita Guerreiro', connections: [3, 7] },
      ...
      { id: 10, row: 4, col: -2, type: 'monster', name: 'Covil de Vulto Alado', connections: [7, 13] },
      ...
      { id: 13, row: 5, col: -1, type: 'monster', name: 'Ninho de Esqueleto Colossal', connections: [10, 15] },
